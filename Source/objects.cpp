...
void GetObjectStr(const Object &object)
{
	...
	if (object.IsDisabled()) {
		InfoString = fmt::format(_(/* TRANSLATORS: If user enabled diablo.ini setting "Disable Crippling Shrines" is set to 1; also used for Na-Kruls leaver */ "{:s}"), InfoString);
		InfoColor = UiFlags::ColorRed;
	}
}
